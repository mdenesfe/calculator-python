...
eb = Button(text="=",fg = 'GREEN',font="Verdana 14 bold",width=2,command=hesapla)
eb.place(x=120,y=200)

cb = Button(text="C",fg = 'RED',font="Verdana 14 bold",width=2,command=sil)
cb.place(x=170,y=200)
